...
export const GOAT_COLLECTIONS: GoatCollection[] = [
  {
    ...
    articles: [
      ...
      { company: '카카오페이', title: '해커톤 경험을 통해 엿본 AI시대에 개발자가 가져야 할 자세', date: '2025.06.19', url: 'https://tech.kakaopay.com/post/kakaopay-hackathon-aiva/', thumb_url: '/goat-thumbs/01-05.jpg' },
  ...
  },
  {
    ...
    articles: [
      ...
      { company: '카카오페이', title: '백엔드 개발자의 시선으로 풀어본 LLM 내부 동작 원리: 6단계로 쉽게 이해하기', date: '2025.09.11', url: 'https://tech.kakaopay.com/post/how-llm-works/', thumb_url: '/goat-thumbs/02-04.jpg' },
  ...
  },
  {
    ...
    articles: [
      ...
      { company: '카카오페이', title: '주니어 개발자의 오픈소스 활동 이야기', date: '2022.11.04', url: 'https://tech.kakaopay.com/post/junior-opensource/', thumb_url: '/goat-thumbs/04-03.jpg' },
      { company: '카카오', title: 'FE개발자의 성장 스토리 10 : 주니어 FE 개발자 오픈소스 성장기', date: '2021.06.16', url: 'https://tech.kakao.com/posts/444', thumb_url: '/goat-thumbs/04-04.jpg' },
  ...
  },
  {
    ...
    articles: [
      { company: '삼성', title: '레거시 코드를 어떻게든 테스트하기', date: '2025.06.10', url: 'https://techblog.samsung.com/blog/article/64' },
      { company: '토스', title: '레거시 인프라 작살내고 하이브리드 클라우드 만든 썰', date: '2026.01.20', url: 'https://toss.tech/article/payments-legacy-9' },
      { company: '우아한형제들', title: '테스트 코드 없이 레거시 코드를 다 감수하시겠습니까?', date: '2019.02.28', url: 'https://techblog.woowahan.com/2613/' },
      ...
      { company: '우아한형제들', title: '레거시 코드를 파괴하는 Vim 벽돌 깨기', date: '2017.07.07', url: 'https://techblog.woowahan.com/2526/' },
